 ...
 *
 *  @param [in] pos_x:   x-coordinate of blending position from origin.
 *                       Negative value is allowed, out of bounds src image will
 *                       be clipped.
 *  @param [in] pos_y:   y-coordinate of blending position from origin.
 *                       Negative value is allowed, out of bounds src image will
 *                       be clipped.
 *  @param [in] src:     Source image can be input as following formats.
 *
 ...
 *  @param [in] alpha:   Alpha plane can be input as following formats.
 *
 *                       - IMAGEPROC_IMGTYPE_SINGLE
