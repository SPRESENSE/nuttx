...
struct cxd56_dmachannel_s *cxd56_get_micdmach(void)
{
  ...
  memset(&mic_dma.delay_work, 0, sizeof(mic_dma.delay_work));
...
struct cxd56_dmachannel_s *cxd56_get_i2s0out_dmach(void)
{
  ...
  memset(&i2s0out_dma.dmach.delay_work, 0, sizeof(i2s0out_dma.dmach.delay_work));
...
struct cxd56_dmachannel_s *cxd56_get_i2s1out_dmach(void)
{
  ...
  memset(&i2s1out_dma.dmach.delay_work, 0, sizeof(i2s1out_dma.dmach.delay_work));
...
struct cxd56_dmachannel_s *cxd56_get_i2s1in_dmach(void)
{
  ...
  memset(&i2s1in_dma.dmach.delay_work, 0, sizeof(i2s1in_dma.dmach.delay_work));
