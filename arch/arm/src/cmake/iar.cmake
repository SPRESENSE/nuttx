...
set(CMAKE_STRIP ielftool)
set(CMAKE_OBJCOPY ielftool)
set(CMAKE_OBJDUMP ielftool)
set(CMAKE_LINKER ilinkarm)
set(CMAKE_LD ilinkarm)
set(CMAKE_AR iarchive)
set(CMAKE_NM ielftool)
set(CMAKE_RANLIB echo)
set(CMAKE_PREPROCESSOR iccarm --preprocess)
...
##  add_compile_options($<$<COMPILE_LANGUAGE:C>:-Ohz>)
endif()
...
set(PREPROCESS ${CMAKE_C_COMPILER} ${CMAKE_C_FLAG_ARGS} --preprocess=n)
...
function(nuttx_generate_preproces_target)
  ...
  add_custom_command(
    OUTPUT ${TARGET_FILE}
    COMMAND ${PREPROCESS} ${TARGET_FILE} -I${CMAKE_BINARY_DIR}/include
            ${SOURCE_FILE}
